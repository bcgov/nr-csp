...
describe('R06InvoicePrintOutPage interactions', () => {
  ...
  it('drops both the typed name and the number when a selection is cleared', () => {
    renderPage();
  ...
  // A name left behind by a cleared field made validateR06 see a name with no number
