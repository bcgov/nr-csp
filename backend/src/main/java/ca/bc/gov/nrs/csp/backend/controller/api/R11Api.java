...
@RequestMapping("/api")
public interface R11Api {

    @Operation(summary = "Generate R11 report", description = "Generates the R11 price list report in PDF or CSV format.")
    @ApiResponses({
    ...
    @PostMapping(value = "/R11",
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = {MediaType.APPLICATION_PDF_VALUE, "text/csv", MediaType.ALL_VALUE})
    ResponseEntity<Resource> generateR11Report(@Valid @RequestBody R11ReportRequest request);
}
