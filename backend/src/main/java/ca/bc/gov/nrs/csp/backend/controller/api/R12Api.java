...
@RequestMapping("/api")
public interface R12Api {

    @Operation(summary = "Generate R12 report", description = "Generates the R12 submission report in PDF or CSV format.")
    @ApiResponses({
    ...
    @PostMapping(value = "/R12",
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = {MediaType.APPLICATION_PDF_VALUE, "text/csv", MediaType.ALL_VALUE})
    ResponseEntity<Resource> generateR12Report(@Valid @RequestBody R12ReportRequest request);
}
