...
@RequestMapping("/api")
public interface R07Api {

    @Operation(summary = "Generate R07 report", description = "Generates the R07 invoice summary report in PDF or CSV format.")
    @ApiResponses({
    ...
    @PostMapping(value = "/R07",
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = {MediaType.APPLICATION_PDF_VALUE, "text/csv", MediaType.ALL_VALUE})
    ResponseEntity<Resource> generateR07Report(@Valid @RequestBody R07ReportRequest request);
}
