...
public class R07ReportRequest {
    ...
    public Boolean getShowReplacesAdjusts() { return showReplacesAdjusts; }
    public void setShowReplacesAdjusts(Boolean showReplacesAdjusts) { this.showReplacesAdjusts = showReplacesAdjusts; }
