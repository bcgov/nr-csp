...
class R07ReportRequestTest {

    @Test
    @DisplayName("defaults to PDF format")
    void defaults() {
        assertThat(new R07ReportRequest().getReportFormat()).isEqualTo(ReportFormat.PDF);
    }
    ...
    void settersAndGettersRoundTrip() {
        ...
        r.setShowReplacesAdjusts(Boolean.TRUE);
        ...
        assertThat(r.getShowReplacesAdjusts()).isTrue();
